...
import kamofoke.swingy.model.CreateHero.*;
import kamofoke.swingy.Files.ReadFile;
import kamofoke.swingy.Files.WriteFile;
import kamofoke.swingy.Controllers.GuiMap;
...
public class DisplayGui extends JFrame {
    ...
    private final JFrame PlayerFrame = new JFrame("Welcome to Swingy");
    ...
    private final JRadioButton Superman = new JRadioButton("SUPERMAN");
    ...
    public void createPlayer(){
        ...
        Superman.setBounds(210,240, 200,30);
    ...
    public void heroStats(){
        ...
        l1 = new JLabel("Hero Name: " + player);
    ...
    public static void gameOver(){
        ...
        label = new JLabel("#####Going on with ur game#####");
